...
|---------------------|----------|------:|
| `verified_official_source` | ตรวจสอบแหล่งข้อมูลทางการแล้ว (ฟิลด์ครบเชิงโครงสร้าง) | 28 |
| `needs_source_url` | อยู่ระหว่างตรวจสอบแหล่งข้อมูล (ต้องการลิงก์ทางการเฉพาะฉบับ) | 5 |
...
- มี `source_url` ระบุชัดเจนใน data: **28**
- มีเฉพาะลิงก์ราชกิจจานุเบกษาแบบหน้าหลัก (ยังไม่ใช่ลิงก์เฉพาะฉบับ): **5**
- ไม่มีลิงก์แหล่งข้อมูลเลย: **0**
- `official_source` เป็น placeholder: **0**
- ไม่มี `last_checked` ระบุชัดใน data: **5**
- หน้า P1/P2 ที่ยังต้องตรวจด้วยมือ: **3**
